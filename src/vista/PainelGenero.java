...
import controle.PainelGeneroControlador;
/**
 * Classe que implementa o painel de Genero e seus metodos referentes aos botoes
 ...
 * @see ActionListener
 * */
public class PainelGenero extends JFrame implements ListSelectionListener, ActionListener {
	private static final long serialVersionUID = -5890976408945966992L;
	
	PainelGeneroControlador menuPainelGenero;
	...
	private JList<String> listaGenero;
	...
	/**
	 * Construtor de painel que gera a tela de Generos e tambem contem a definicao de suas
	 * caracteristicas graficas 
	 * 
	 * Os metodos atrelados aos botoes e outras funcoes do painel estao contidas no backend
	 * 
	 * @see PainelGeneroControlador
	 * */
	public PainelGenero() {
		...
		menuPainelGenero = new PainelGeneroControlador(this);
		...
		tituloPagina = new JLabel("Genero literario");
		tituloPagina.setBounds(90, 33, 281, 29);
		tituloPagina.setForeground(new Color(255, 204, 0));
		...
		botaoBuscar.setBounds(881, 44, 86, 23);
		...
		listaGenero = new JList<String>();
		listaGenero.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		listaGenero.setModel(menuPainelGenero.gerarModeloLista());
		listaGenero.setBackground(new Color(204, 204, 204));
		painelInterativo.setViewportView(listaGenero);
		listaGenero.setFixedCellHeight(50);
		listaGenero.setFixedCellWidth(70);
		listaGenero.addListSelectionListener(this);

		//Campo onde eu posso digitar valores para serem buscados na minha lista e exibidos 
		//painel principal.
		campoBusca = new JTextField();
		campoBusca.setBounds(711, 44, 160, 23);
		...
		//Painel de acesso rapido a outras janelas(Autores, Menu , Livros)
		...
		botaoIconeGenero.setIcon(new ImageIcon(PainelGenero.class.getResource("/bancoImagens/generoPB.png")));
	...
	public JList<String> getListaGenero() {
		return listaGenero;
	}
	...
	public void actionPerformed(ActionEvent x) {
		menuPainelGenero.acaoPerformadaGenero(x);
	}
	...
	public void valueChanged(ListSelectionEvent e) {
		menuPainelGenero.informacoesLista(e);
	}
